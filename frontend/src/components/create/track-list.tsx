...
import { Download, Loader, Loader2, MoreHorizontal, Music, Pencil, Play, RefreshCcw, Search, XCircle } from "lucide-react";
            ...
            <div className="space-y-2">
                {filteredTracks.length > 0 ? (
                        ...
                        switch (track.status) {
                                    ...
                                    className="flex cursor-not-allowed items-center gap-4 rounded-lg p-3">
                                        ...
                                        <div className="min-w-0 flex-1">
                                            ...
                                            <p className="text-muted-foreground truncate text-xs">
                                                ...
                                                Purchasing credits helps me to maintain the service.
                                            </p>
                                        </div>
                                    </div>
                                );
                            ...
                            case "processing":
                                return (
                                    ...
                                    key = {track.id}
                                    className="flex cursor-not-allowed items-center gap-4 rounded-lg p-3">
                                        <div className="bg-muted-not-allowed items-center gap-4 rounded-lg p-3">
                            ...
                            default:
                                return (
                                    ...
                                    onClick={() => handleTrackSelect(track)}>
                                        {/* Thumbnail */}
                                        <div className="group relative h-12 w-12 flex-shrink-0 overlflow-hidden rounded-md">
                                            {track.thumbnailUrl ? (
                                                <img
                                        ...
                                        <div className="flex items-center gap-2">
                                            ...
                                            <DropdownMenu>
                                                ...
                                                <DropdownMenuContent align = "end" className="w-40 bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-700 rounded-md shadow-md">
                                                    <DropdownMenuItem 
                                                    onClick={async (e) => {
                                                        e.stopPropagation();
                                                        const playUrl = await getPlayUrl(track.id);
                    ...
                    <div className="flex flex-col items-center justify-center pt=20 text-center">
                        ...
                        <h2 className="mt-4 text-lg font-semibold">No Music Generated Yet</h2>
                        <p className="text-muted-foreground mt-1 text-sm">
                            {searchQuery
                            ? "No tracks match your search."
                            : "Create your first song to get stated."}
                        </p>
                    </div>
                )}
            </div>
