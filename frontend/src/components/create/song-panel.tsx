...
import { Loader2, Music, Plus, SwitchCamera } from "lucide-react";
...
export function SongPanel() {
    ...
    const handleCreate = async () => {
        ...
        if (mode === "custom" && !styleInput.trim()) {
            toast.error("Please enter a style before creating.");
            return;
        }
        ...
        if (mode === "simple") {
            requestBody = {
                fullDescribedSong: description, instrumental,
            };
        } else {
            ...
            if (lyricsMode === "write") {
                ...
                requestBody = {
                    prompt,
                    describedLyrics: lyrics,instrumental,
                };
            }
        }
        try {
                ...
                <Tabs value={mode} onValueChange={(value) => setMode(value as "simple" | "custom")}>
                    ...
                    <TabsContent value = "simple" className="mt-6 space-y-6">
                        <div className="flex flex-col gap-3">
                            ...
                            placeholder="An ambient house track, smooth rhythms for focus and deep work" className="min-h-[120px] resize-none"></Textarea>
                        </div>
                        ...
                        <div className="flex flex-col gap-3">
                            <div className="flex items-center justify-between">
                                ...
                                <div className="flex items-center gap-1">
                                    <Button
                                    variant={lyricsMode == "auto" ? "secondary" : "ghost"} onClick={() => {
                                        setLyricsMode("auto");
                                        setLyrics("");
                            ...
                            <Textarea 
                            placeholder={
                                lyricsMode == "write" ? "Write your lyrics here..." : "Describe your song, eg., A chill song to relax"
                            } value={lyrics} 
