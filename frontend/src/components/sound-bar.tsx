...
import { Download, MoreHorizontal, Music, Pause, Play, VolumeX, Volume2 } from "lucide-react";
...
export default function SoundBar() {
    ...
    return (
        <div className="px-4 pb-2">
            <Card className="bg-background/60 relative w-full shrink-0 border-t py-0 backdrop-blue">
